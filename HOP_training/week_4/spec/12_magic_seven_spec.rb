...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    it 'subtracts four from the given number' do
      number = 10 # Arrange
  ...
  describe '#divide_by_two' do
    it 'divides the given number by two' do
      number = 16
  ...
  describe '#subtract_random_number' do
    it 'subtracts the random number from the given number' do
      number = 20
      random_number = 5
      game_with_random = described_class.new(random_number)
      result = game_with_random.subtract_random_number(number)
      expect(result).to eq(15)
    end
  end
  ...
  describe '#play' do
    context 'when the random number is 10' do
      it 'will return 7' do
        game_with_random = described_class.new(10)
        expect(game_with_random.play).to eq(7)
      end
    end

    context 'when the random number is 0' do
      it 'will return 7' do
        game_with_random = described_class.new(0)
        expect(game_with_random.play).to eq(7)
      end
    end
    ...
    context 'when the random number is 42' do
      it 'will return 7' do
        game_with_random = described_class.new(42)
        expect(game_with_random.play).to eq(7)
      end
    end
  end
